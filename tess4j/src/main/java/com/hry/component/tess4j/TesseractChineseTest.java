...
public class TesseractChineseTest {
	public static void main(String[] args) {
		...
		File root = new File(System.getProperty("user.dir") + "/tess4j/src/main/resources/com/hry/component/tess4j/china/");
		 ...
		 * 
		 */
        tessreact.setDatapath(System.getProperty("user.dir") + "/tess4j/src/main/resources/com/hry/component/tess4j/tessdata/");
        // 设置识别语言，默认为英文
